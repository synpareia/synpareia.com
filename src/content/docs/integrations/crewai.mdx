...
<Aside type="note">
This page describes the supported integration as of synpareia-trust-mcp 0.9.0. A higher-level CrewAI wrapper may ship later, but the MCPServerAdapter route is stable and covers every Trust Toolkit tool.
</Aside>
